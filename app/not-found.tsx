...
const NotFound = () => {
  return (
    <div className="relative z-10 h-screen max-h-screen min-h-screen w-full bg-[url(/frame-1.jpg)] max-lg:bg-position-[20%] max-md:bg-position-[30%] max-sm:bg-position-[55%] min-[1920px]:bg-cover">
