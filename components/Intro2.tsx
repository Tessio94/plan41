      ...
      <div className="flex flex-row items-center justify-between gap-40">
        ...
        <div className="w-1/2">
          ...
          <ul className="flex flex-col items-start gap-7">
            <motion.li
              className="to-theme2/40 border-theme1 shadow-theme2/40 hover:from-theme2/10 hover:to-theme2/60 flex w-full flex-row items-center gap-7 rounded-2xl border-2 bg-linear-to-br from-transparent px-5 py-3 text-xl shadow-xl transition-colors duration-300 hover:bg-linear-to-br"
