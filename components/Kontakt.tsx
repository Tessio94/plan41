  ...
  return (
    <section className="bg-theme1 max_3xl:flex-col max_3xl:items-start flex flex-row items-end justify-between px-6 py-26 sm:px-10 lg:px-18 2xl:px-28">
      ...
      >
        <Link
          href="/kontakt"
          className="text-theme1 bg-theme3 hover:bg-theme2 hover:text-theme3 active:bg-theme2 active:text-theme3 focus:bg-theme2 focus:text-theme3 border-theme3 group mt-5 flex w-fit flex-row items-center gap-5 rounded-xl border-2 px-5 py-3 text-2xl font-bold transition-colors duration-300"
        >
          Kontakt{" "}
