        ...
        <div className="flex flex-col gap-15 md:gap-25 lg:flex-row lg:gap-10 xl:gap-13 2xl:gap-15">
          <div className="flex w-full flex-col gap-5 lg:w-1/2">
            ...
            >
              ...
              autentični. Sljedeći korak je strategija, a kada dođete do
              poslovnog plana, obratite mi se
            </m.p>
            <m.p
              className="font-inter text-2xl"
              initial={{ y: 50, opacity: 0 }}
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              Ukoliko ste svoju poslovnu ideju sami razradili i pripemili
              poslovni plan, ukoliko želite savjet, mentorstvo, podršku i pomoć,
              zatražite to
            </m.p>
            <m.div
              initial={{ y: 50, opacity: 0 }}
              ...
              >
                ...
                >
                  <p className="pt-2 text-lg">
                    ...
                    sigurnije donosili odluke i imali kvalitetnu dokumentaciju
                    za financiranje i ulaganja.
                  </p>
                </div>
              </li>
              <li
              ...
              >
                ...
                >
                  <p className="pt-2 text-lg">
                    ...
                    namijenjene samozapošljavanju. Pomažem vam oblikovati
                    poslovnu ideju u jasnu i izvedivu strukturu, pripremiti svu
                    potrebnu dokumentaciju i argumentirano obrazložiti održivost
                    vašeg projekta — sve kako bi vaš zahtjev imao najbolje šanse
                    za odobrenje.
                  </p>
                </div>
              </li>
