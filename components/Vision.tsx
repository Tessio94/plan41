...
const Vision = () => {
  ...
  return (
    <section className="bg-background2 relative z-0 px-6 py-26 sm:px-10 lg:px-18 2xl:px-28">
      ...
      <div className="mx-auto flex w-full max-w-[85%] flex-col items-center max-[1650]:max-w-[92%] max-[1380]:max-w-[97%] max-[1160px]:max-w-full lg:flex-row">
        {/* <motion.div className="relative flex flex-col gap-6 w-1/2 bg-background2 py-8 px-6 rounded-2xl  intro-card"> */}
        <motion.div
          className="from-theme3/30 via-theme3 to-theme1 shadow-theme1/20 relative order-2 -mt-120 w-1/2 rounded-2xl bg-conic/[from_var(--border-angle)] p-1 shadow-xl max-[1024px]:w-[80%] max-[850px]:-mt-75 max-[590px]:w-[92%] max-lg:max-w-[95%] lg:order-1 lg:mt-0"
        ...
        >
          <div className="bg-background2 flex flex-col gap-6 rounded-2xl px-6 py-8 max-[530px]:px-4">
            ...
            >
              <motion.li
                className="flex flex-row items-center gap-6 max-[530px]:gap-4"
                variants={cardVariants}
              >
                <GiCheckMark className="text-theme3 shrink-0 text-3xl" />
        ...
        <motion.div
          className="-z-10 order-1 h-full w-1/2 max-[1024px]:-mt-50 max-[810px]:-mt-40 max-[590px]:-mt-30 lg:order-2 lg:mt-0 lg:-ml-18"
          initial={{ y: 100, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1, transition: { duration: 1 } }}
          viewport={{ once: true, amount: 0.3 }}
        >
          <Image
            className="shadow-theme1/20 h-[120%] rounded-2xl shadow-xl max-[1279px]:aspect-3/5 max-[1160px]:aspect-1/2 max-lg:rotate-270 xl:aspect-7/10"
